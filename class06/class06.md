...
- [Gradebook Function](#gradebook-function)
- [Add function](#add-function)
- [DNA Sequence Generator](#dna-sequence-generator)
...
> single score. If a student misses a homework (i.e. has anNA value)
> this can be used as a score to be potentially dropped. Your final
> function should beadquately explained with code comments and be able
...
Now apply the grade function to the gradebook and determine the top
scoring student.
...
Lets create a bar plot to visualize the difficulty of each homework
assignment and confirm our findings.
...
![Homework Difficulty
Analysis](class06_files/figure-commonmark/Plot%20homework%20difficulty-1.png)

So we can confirm that homework 2 was the toughest on students as it has
the lowest median score among all assignments, despite having outliers
with high scores.
...
```
     ...
     [1] "G" "C" "C" "T" "C" "C" "A" "A" "G" "A"

Improve the function to return the sequence as a single string rather
than a vector of characters.
...
The sequences HMETFW, WEGYAGI, and HRFGTKTA were not unique as they are
found in nature with 100% identity and 100% query coverage according to
BLAST results. The other sequences generated were unique and not found
in nature based on BLAST search results.
